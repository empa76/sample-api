...
ActiveRecord::Schema.define(version: 20150831201558) do
  ...
  add_index "areas", ["location_group_id"], name: "index_areas_on_location_group_id"
  ...
  add_index "objectives", ["country_id"], name: "index_objectives_on_country_id"
  add_index "objectives", ["target_group_id"], name: "index_objectives_on_target_group_id"
